...
public class DefaultParser implements ILrcParser {

    static final String TAG = "DefaultParser";

    public List<Lrc> getLrcRows(String rawLrc) {
        ...
        try {
            ...
            do {
                ...
                if (line != null && line.length() > 0) {
                    ...
                    List<Lrc> lrcRows = Lrc.createRows(line);
